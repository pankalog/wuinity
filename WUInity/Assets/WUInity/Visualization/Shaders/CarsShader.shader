...
Shader "WUInity/VehiclesURP"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // x = pos.x, y = pos.z, z = paletteIndex
            #if defined(UNITY_PROCEDURAL_INSTANCING_ENABLED)
            StructuredBuffer<float4> _PositionsAndState;
            #endif

            // ---------------------------------------------------------
            // Per-instance transform rows (DX11-legal)
            // ---------------------------------------------------------
            ...
            // ---------------------------------------------------------
            // Procedural instancing transform
            // ---------------------------------------------------------
            ...
            #if defined(UNITY_PROCEDURAL_INSTANCING_ENABLED)
                float4 data = _PositionsAndState[unity_InstanceID];
                o.uv = float2(data.z, 0.125);     // palette index
            #else
